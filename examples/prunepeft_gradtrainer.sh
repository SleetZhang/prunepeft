#!/bin/bash
# PrunePEFT training script with GradTrainer
# Author: Based on prunepeft.sh, modified to use GradTrainer for gradient recording
...
# Build command
CMD="python examples/prunepeft_gradtrainer.py \
...
# Execute command
echo "Running PrunePEFT with GradTrainer..."
echo "Command: $CMD"
eval $CMD
